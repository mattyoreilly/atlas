...
a one-call wrapper around an `atlas_session`, which lives in the run
directory as much as in memory: data, code log, conversation, and
artifacts (report, leaderboard, models, validation plots) are all on
